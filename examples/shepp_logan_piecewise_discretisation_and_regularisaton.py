...
Code example:
    ...
    Shepp-Logan piecewise discretisation and regularisation."""
...
reco_coarse_list = []
iter = -1
for counter in (1,2,4,8,16): #Iterate over discretisations 1:16 --> 1:1
    # %%
    iter += 1
    
    # Outside discretisation
    min_pt = [-10, -10]
    max_pt = [10, 10]
    points_orig = [25, 25]
    points_orig = [i*1 for i in points_orig]
    points =  [i * counter for i in points_orig]
