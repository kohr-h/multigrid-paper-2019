...
insert_min_pt_1 = [2.5, -7.5]
insert_max_pt_1 = [7.62, 2.58]
fine_discr_1 = odl.uniform_discr(min_pt, max_pt, [128, 128])
...
# Mask
coarse_mask_1 = multigrid.operators.MaskingOperator(coarse_discr,
                                                    insert_min_pt, insert_max_pt)

coarse_mask_2 = multigrid.operators.MaskingOperator(coarse_discr, 
                                                    insert_min_pt_1, insert_max_pt_1)

# Utilize multiple ROIs
coarse_mask = coarse_mask_1 * coarse_mask_2
